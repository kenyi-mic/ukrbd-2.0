  ...
  return (
    <SafeAreaView className="flex-1 z-0">
      <ScrollView>
        ...
        <View className="flex flex-row space-x-2 ml-2 items-center">
          <TouchableOpacity className=" w-40 bg-yellow-400 border shadow-sm p-2 rounded-lg">
            <Text className="text-lg">Create review</Text>
          </TouchableOpacity>
          <TouchableOpacity className="w-40 bg-white border shadow-sm p-2 rounded-lg">
            <Text className="text-lg">Create review</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
