  ...
  return (
    <SafeAreaView className="flex-1 z-0">
      <ScrollView>
        ...
        {/*Orders*/}
        <Text className="text-gray-700 ml-4 text-xl font-bold">Orders</Text>
        <View className="flex flex-row items-center">
          <TouchableOpacity className="flex flex-col items-center ml-4">
            <Image
              className="w-10 h-20 mx-4 rounded-xl"
              source={{
            ...
            />
            <Text className="text-xs text-center">Iphone 12 pro</Text>
          </TouchableOpacity>
          <TouchableOpacity className="flex flex-col items-center ml-4">
            <Image
              className="w-10 h-20 mx-4 rounded-xl"
          ...
          <TouchableOpacity className="flex flex-col items-center ml-4">
            <Image
              className="w-10 h-20 mx-1 rounded-xl"
              source={{
                uri: "https://imgs.search.brave.com/jTyU-REwDGZQ0WOMTU5D4gtIRG4wgL9S56jpd_BWmy4/rs:fit:940:1112:1/g:ce/aHR0cHM6Ly9wbmdp/bWcuY29tL3VwbG9h/ZHMvaXBob25lXzEy/L2lwaG9uZV8xMl9Q/TkcxOS5wbmc",
              }}
            />
