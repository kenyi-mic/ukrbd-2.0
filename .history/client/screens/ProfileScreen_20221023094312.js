  ...
  return (
    <SafeAreaView style={styles.Container}>
      ...
      <View className="m-4 items-center">
        <View className="flex flex-row items-center justify-between w-full space-y-2">
          <ProfileBotton title="Your Orders" action="orders" />
          <ProfileBotton title="Buy Again" action="account" />
        </View>
        <View className="flex flex-row items-center justify-between w-full">
          <ProfileBotton title="Your Account" action="account" />
          <ProfileBotton title="Your Account" action="account" />
        </View>
      </View>
    </SafeAreaView>
