...
const CategoryScreen = () => {
  ...
  const _renderItem = ({ item }) => (
    ...
    >
      ...
      <View className="bg-slate-700 w-full h-10 absolute bottom-0 opacity-10"></View>
      <Text
        numberOfLines={2}
        className="absolute drop-shadow-xl bottom-2  text-center mt-8 text-lg w-full pt-2 text-white font-semibold "
      >
        {item.name}
      </Text>
    </TouchableOpacity>
