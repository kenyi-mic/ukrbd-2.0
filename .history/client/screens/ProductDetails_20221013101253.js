    ...
    <ScrollView>
      <View key={id}>
        <View className="items-center">
          ...
          {/*basket*/}
          <TouchableOpacity className="absolute top-8 right-2 items-center flex flex-1">
            <ShoppingCartIcon color="#FF9900" size={40} />
            <Text className="absolute right-1 top-1 text-sm text-white font-bold bg-green-500 w-4 h-4 text-center p-1">
              0
            </Text>
          </TouchableOpacity>
        </View>
