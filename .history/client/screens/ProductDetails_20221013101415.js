    ...
    <ScrollView>
      <View key={id}>
        <View className="items-center">
          ...
          {/*basket*/}
          <TouchableOpacity className="absolute top-8 right-2 ">
            <ShoppingCartIcon color="#FF9900" size={40} />
            <Text className="absolute right-0 top-1 text-sm text-white font-bold bg-green-500 w-5 h-5 rounded-full text-center ">
              0
            </Text>
          </TouchableOpacity>
        </View>
