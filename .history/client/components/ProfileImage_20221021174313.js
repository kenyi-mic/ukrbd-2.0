...
const ProfileImage = () => {
  ...
  return (
    <View className="w-24 h-24 rounded-full bg-slate-500 absolute -bottom-12 ml-4 border-4 border-white">
      <Pressable
        className="absolute bottom-1 shadow right-8 opacity-60"
      ...
      {profileData.map((item) => (
        <TouchableOpacity
          key={item.id}
          className="absolute -bottom-12 z-10 ml-4  rounded-full  "
        >
          <Image
