    ...
    <ScrollView>
      <View key={id}>
        ...
        <View className="ml-3">
          ...
          {/* alterntive image*/}
          <View>
            <Text className="text-xl font-semibold">Color</Text>
            <View className="flex flex-row"></View>
          </View>
          <Text className="text-xl font-semibold">Size</Text>
          <View className="item-center my-3 flex flex-row ">
            <Text className="text-xl border-2 p-1 w-8 h-8 text-center mr-1">
              S
            </Text>
            <Text className="text-xl border-2 p-1 w-8 h-8 text-center mx-1">
              M
            </Text>
            <Text className="text-xl border-2 p-1 w-8 h-8 text-center mx-1">
              L
            </Text>
            <Text className="text-xl border-2 p-1 w-8 h-8 text-center ml-1">
              XL
            </Text>
          </View>
